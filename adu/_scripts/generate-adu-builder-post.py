#!/usr/bin/env python3
"""Generate ADU builder selection satellite post and update blog listing."""
import re
import sys
...
SLUG = "how-to-choose-an-adu-builder-in-massachusetts"
POST_DIR = ADU / SLUG
TEMPLATE = ADU / PILLAR_SLUG / "index.html"
CONTENT_FILE = SCRIPTS / "adu-builder-content.html"
POST_TITLE = (
    "How to Choose an ADU Builder in Massachusetts: Criteria, Questions, and Red Flags"
)
POST_EXCERPT = (
...
def build_post_page(article_html: str) -> str:
    ...
    html = re.sub(
        ...
        '<meta name="keywords" content="ADU builder Massachusetts, choose ADU contractor, ADU design-build Massachusetts, HIC CSL contractor, JRH Constructions">',
        html,
        count=1,
    )
