#!/usr/bin/env python3
"""Generate ADU floor plans satellite post and update blog listing."""
import re
import sys
...
SLUG = "adu-floor-plans-for-massachusetts"
POST_DIR = ADU / SLUG
TEMPLATE = ADU / PILLAR_SLUG / "index.html"
CONTENT_FILE = SCRIPTS / "adu-floor-plans-content.html"
POST_TITLE = "ADU Floor Plans for Massachusetts: Layouts That Maximize Space, Rent, and Livability"
POST_EXCERPT = (
...
def build_post_page(article_html: str) -> str:
    ...
    html = re.sub(
        ...
        '<meta name="keywords" content="ADU floor plans Massachusetts, one bedroom ADU layout, studio ADU plan, ADU design, JRH Constructions">',
        html,
        count=1,
    )
