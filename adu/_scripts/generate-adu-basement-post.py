#!/usr/bin/env python3
"""Generate basement ADU satellite post and update blog listing."""
import re
import sys
...
SLUG = "basement-adu-conversion-in-massachusetts"
POST_DIR = ADU / SLUG
TEMPLATE = ADU / PILLAR_SLUG / "index.html"
CONTENT_FILE = SCRIPTS / "adu-basement-content.html"
POST_TITLE = "Basement ADU Conversion in Massachusetts: Costs, Building Codes, and Feasibility"
POST_EXCERPT = (
...
def build_post_page(article_html: str) -> str:
    ...
    html = re.sub(
        ...
        '<meta name="keywords" content="basement ADU Massachusetts, basement apartment conversion, ADU building code, basement egress, JRH Constructions">',
        html,
        count=1,
    )
