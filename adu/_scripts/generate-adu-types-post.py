#!/usr/bin/env python3
"""Generate ADU types comparison satellite post and update blog listing."""
import re
import sys
...
SLUG = "which-adu-type-is-best-for-your-massachusetts-home"
POST_DIR = ADU / SLUG
TEMPLATE = ADU / PILLAR_SLUG / "index.html"
CONTENT_FILE = SCRIPTS / "adu-types-content.html"
POST_TITLE = (
    "Detached, Attached, or Garage Conversion: Which ADU Type Is Best for Your Massachusetts Home?"
)
POST_EXCERPT = (
...
def build_post_page(article_html: str) -> str:
    ...
    html = re.sub(
        ...
        '<meta name="keywords" content="ADU types Massachusetts, detached ADU, garage conversion ADU, attached ADU, basement ADU, JRH Constructions">',
        html,
        count=1,
    )
