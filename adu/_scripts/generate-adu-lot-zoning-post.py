#!/usr/bin/env python3
"""Generate ADU lot/zoning satellite post and update blog listing."""
import re
import sys
...
SLUG = "can-you-build-an-adu-on-your-massachusetts-property"
POST_DIR = ADU / SLUG
TEMPLATE = ADU / PILLAR_SLUG / "index.html"
CONTENT_FILE = SCRIPTS / "adu-lot-zoning-content.html"
POST_TITLE = (
    "Can You Build an ADU on Your Massachusetts Property? Lot and Zoning Requirements Explained"
)
POST_EXCERPT = (
...
def build_post_page(article_html: str) -> str:
    ...
    html = re.sub(
        ...
        '<meta name="keywords" content="ADU lot requirements Massachusetts, ADU zoning Massachusetts, can I build ADU on my property, Title 5 ADU, ADU setbacks, JRH Constructions">',
        html,
        count=1,
    )
