#!/usr/bin/env python3
"""Generate ADU timeline satellite post and update blog listing."""
import re
import sys
...
SLUG = "how-long-does-it-take-to-build-an-adu-in-massachusetts"
POST_DIR = ADU / SLUG
TEMPLATE = ADU / PILLAR_SLUG / "index.html"
CONTENT_FILE = SCRIPTS / "adu-timeline-content.html"
POST_TITLE = "How Long Does It Take to Build an ADU in Massachusetts? The Real Timeline From Sketch to Move-In"
POST_EXCERPT = (
...
def build_post_page(article_html: str) -> str:
    ...
    html = re.sub(
        ...
        '<meta name="keywords" content="ADU timeline Massachusetts, how long to build ADU, ADU construction schedule, ADU permits timeline, JRH Constructions">',
        html,
        count=1,
    )
