#!/usr/bin/env python3
"""Generate ADU ROI satellite post and update blog listing."""
import re
import sys
...
SLUG = "adu-roi-in-massachusetts"
POST_DIR = ADU / SLUG
TEMPLATE = ADU / PILLAR_SLUG / "index.html"
CONTENT_FILE = SCRIPTS / "adu-roi-content.html"
POST_TITLE = "ADU ROI in Massachusetts: Rental Income, Property Value, and Payback Explained With Real Numbers"
POST_EXCERPT = (
...
def build_post_page(article_html: str) -> str:
    ...
    html = re.sub(
        ...
        '<meta name="keywords" content="ADU ROI Massachusetts, ADU rental income, ADU property value, ADU payback period, ADU investment, JRH Constructions">',
        html,
        count=1,
    )
